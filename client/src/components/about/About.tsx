        ...
        <div>
            ...
            <div className='row'>
                ...
                <div className='col-md-8'>
                    ...
                    <div>
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <b>Special contribution: </b>stabilizing the
                                    development life-cycle of two of Five
                                    Degrees' biggest customers, by applying
                                    SCRUM and Agile methodologies, introducing
                                    code standards, unit testing, integration
                                    testing, build and deployment automation,
                                    team coherence and trust
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div>
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <b>Special contribution: </b>: development
                                    of a project template, upon which more than
                                    50 games were built
                                </li>
                            </ul>
                        </div>
                    ...
                    <div>Bachelor of Software Engineering, 2018-Present</div>
